"""Example file on how to render 1 frame of the world."""
...
def render_frame(
    ...
    color_sdf = partial(__scene_sdf_from_tilemap_color, tilemap, terrain_color=terrain_color, with_color=True)
...
if __name__ == "__main__":  # pragma: no cover
    ...
    imageio.mimsave(f"tests/video_output/sdf_world_scene.mp4", frames, fps=24, quality=8)
